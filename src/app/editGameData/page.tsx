...
export default async function GameDataEditorPage() {
  ...
  return (
    <ClientLayout>
      ...
      <div className="bg-amber-950 p-4 md:p-6 rounded-lg border border-amber-700 shadow-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 mt-6 md:mt-8">
          {[
            ...
            <Link 
              key={category.name} 
              href={category.path}
              className="bg-amber-800/50 p-4 md:p-5 rounded-lg shadow-md hover:shadow-lg transition-all border border-amber-700/50 hover:bg-amber-700/50 group"
            >
