 ...
 */
export async function getItemEffectTypes(): Promise<EffectType[]> {
 ...
 */
export async function getSkillEffectTypes(): Promise<EffectType[]> {
  return EFFECT_TYPES.filter(effect => 
 ...
 */
export async function getEffectTypesByCategory(category: string): Promise<EffectType[]> {
 ...
 */
export async function getEffectTypeByValue(value: string): Promise<EffectType | undefined> {
 ...
 * Server-side version
 */
export async function addCustomEffectTypes(effects: Record<string, any>[]): Promise<void> {
